...
const ProjectCard = (props: CardProps) => {
  return (
    <a href={props.projectLink} target="_blank">
      <div className="group h-full max-w-[600px] dark:bg-gray-600 bg-gray-400 rounded-md backdrop-filter backdrop-blur-[2px] dark:bg-opacity-20 bg-opacity-20 p-4 my-2 hover:shadow-md shadow-black cursor-pointer border-t-[1px] border-t-transparent dark:border-t-slate-600 border-t-slate-50">
